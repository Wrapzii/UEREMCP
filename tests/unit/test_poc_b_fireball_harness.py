...
class FireballHarnessContractTest(unittest.TestCase):
    ...
    def test_filter_enforces_single_call_manifest_and_binding_proof(self):
        ...
        for token in (
            ...
            'TEXT("B1_single_request_complete")',
            'TEXT("B3_six_emitters_present")',
            'TEXT("B4_material_bindings_verified")',
            'TEXT("B5_user_parameters_present")',
            'TEXT("B6_compile_awaited")',
            'TEXT("B8_assets_saved")',
            'TEXT("B9_change_manifest_present")',
            'TEXT("B9_change_manifest_complete")',
            'TEXT("material_bindings_verified")',
            "renderer_bindings_verified",
            "UEREMCP_POC_B_FIREBALL_GATES",
