...
public:
	 ...
	 * Example: {"protocol_version":"1.0","action":"inspect_environment","target":{"asset_path":"/Game/__UeremcpPoc/Alpine"},"specification":{}}
	 */
	UFUNCTION(meta = (AICallable), Category = "UEREMCP|Environment")
	 ...
	 * Inputs: action=validate_environment; specification has no required keys.
	 * Example: {"protocol_version":"1.0","action":"validate_environment","target":{"asset_path":"/Game/__UeremcpPoc/Alpine"},"specification":{}}
	 */
	UFUNCTION(meta = (AICallable), Category = "UEREMCP|Environment")
